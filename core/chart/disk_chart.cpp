...
#include <stdint.h>
#include <errno.h>
DISK_Chart::DISK_Chart(QWidget *parent)
    :Basic_Chart(parent)
{
...
DISK_Chart::~DISK_Chart()
{
    if (disk_chart_list)
    {
        disk_chart_list->removeOne(this);
    }
}
void DISK_Chart::get_disk_data()
{
...
void DISK_Chart::save(QSettings *settings)
{
...
void DISK_Chart::load(QSettings *settings)
{
...
void DISK_Chart::set_icon(QString checked_icon_path)
{
