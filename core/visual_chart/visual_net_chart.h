#ifndef VISUAL_NET_CHART_H
#define VISUAL_NET_CHART_H
#include "visual_basic_chart.h"

class Visual_NET_Chart : public Visual_Basic_Chart
{
    Q_OBJECT
public:
    explicit Visual_NET_Chart(QWidget *parent = nullptr);
    ~Visual_NET_Chart();
