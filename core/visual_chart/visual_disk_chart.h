#ifndef VISUAL_DISK_CHART_H
#define VISUAL_DISK_CHART_H
#include "visual_basic_chart.h"

class Visual_DISK_Chart : public Visual_Basic_Chart
{
    Q_OBJECT
public:
    explicit Visual_DISK_Chart(QWidget *parent = nullptr);
    ~Visual_DISK_Chart();
...
private:
    ...
    int vector_long = 60;
    QColor line1_color = QColor(106, 215, 135, 255);
    QColor line2_color = QColor(143, 136, 225, 255);
    int axis_type = 0;
