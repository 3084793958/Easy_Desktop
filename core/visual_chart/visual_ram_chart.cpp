...
#include <stdint.h>
#include <errno.h>
Visual_RAM_Chart::Visual_RAM_Chart(QWidget *parent)
    :Visual_Basic_Chart(parent)
{
    ...
    connect(updateTimer, &QTimer::timeout, this, &Visual_RAM_Chart::timeout_slot);
...
void Visual_RAM_Chart::timeout_slot()
{
    updateTimer->setInterval(update_time);
    get_ram_data();
...
Visual_RAM_Chart::~Visual_RAM_Chart()
{
    if (visual_ram_chart_list)
    {
        visual_ram_chart_list->removeOne(this);
    }
}
void Visual_RAM_Chart::get_ram_data()
{
...
void Visual_RAM_Chart::save(QSettings *settings)
{
...
void Visual_RAM_Chart::load(QSettings *settings)
{
...
void Visual_RAM_Chart::contextMenuEvent(QContextMenuEvent *event)
{
