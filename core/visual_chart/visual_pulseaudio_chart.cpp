#include "visual_pulseaudio_chart.h"
void Visual_PulseAudio_Chart::set_icon(QString checked_icon_path)
{
...
Visual_PulseAudio_Chart::Visual_PulseAudio_Chart(QWidget *parent)
    :Visual_Basic_Chart(parent)
{
    ...
    connect(pa_timer, &QTimer::timeout, this, &Visual_PulseAudio_Chart::pa_update);
    pa_timer->start();
    show();
}
Visual_PulseAudio_Chart::~Visual_PulseAudio_Chart()
{
    if (visual_pulseaudio_chart_list)
    {
        visual_pulseaudio_chart_list->removeOne(this);
    }
    pa_delete();
}
void Visual_PulseAudio_Chart::pa_init()
{
    ...
    pa_context_set_state_callback(context, [](pa_context *c, void *userdata)
    {
        ...
        {
            Visual_PulseAudio_Chart *pulseaudio_chart = static_cast<Visual_PulseAudio_Chart *>(userdata);
            pulseaudio_chart->pa_start_monitor();
        }
    }, this);
}
void Visual_PulseAudio_Chart::pa_delete()
{
    if (context)
    {
...
void Visual_PulseAudio_Chart::pa_start_monitor()
{
    input_name = nullptr;
    output_name = nullptr;
...
void Visual_PulseAudio_Chart::pa_start_main_finished(Stream_Type type)
{
...
void Visual_PulseAudio_Chart::stream_main_read_callback(pa_stream *p, size_t nbytes, void *userdata)
{
    Visual_PulseAudio_Chart *pulseaudio_chart = static_cast<Visual_PulseAudio_Chart *>(userdata);
...
void Visual_PulseAudio_Chart::pa_update()
{
    if (connecting)
    {
        pa_timer->setInterval(10);
...
void Visual_PulseAudio_Chart::update_data_size()
{
...
void Visual_PulseAudio_Chart::save(QSettings *settings)
{
...
void Visual_PulseAudio_Chart::load(QSettings *settings)
{
...
void Visual_PulseAudio_Chart::contextMenuEvent(QContextMenuEvent *event)
{
