...
protected:
    ...
    QMenu *tree_setting = new Trans_Menu(tr("图标视图控制"), "图标视图控制", this->metaObject()->className(), this);
    ...
    QMenu *sort_type_menu = new Trans_Menu(tr("排序方式"), "排序方式", this->metaObject()->className(), this);
    QAction *sort_type_name = new Trans_Action(tr("名称(顺)"), "名称(顺)", this->metaObject()->className(), this);
    QAction *sort_type_size = new Trans_Action(tr("大小(顺)"), "大小(顺)", this->metaObject()->className(), this);
    QAction *sort_type_date = new Trans_Action(tr("日期(顺)"), "日期(顺)", this->metaObject()->className(), this);
    QAction *sort_type_name_Z = new Trans_Action(tr("名称(反)"), "名称(反)", this->metaObject()->className(), this);
    QAction *sort_type_size_Z = new Trans_Action(tr("大小(反)"), "大小(反)", this->metaObject()->className(), this);
    QAction *sort_type_date_Z = new Trans_Action(tr("日期(反)"), "日期(反)", this->metaObject()->className(), this);
